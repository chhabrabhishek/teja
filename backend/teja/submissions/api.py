...
from teja.submissions.streaks import record_publish
...
def annotate_reactions(submissions: list[Submission], viewer) -> tuple[dict, dict]:
    ...
    from teja.social.models import Reaction
