...
class DabbleField extends StatelessWidget {
  const DabbleField({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoTextField(
      ...
      placeholderStyle: (textStyle ?? DabbleText.body).on(c.inkTertiary),
      style: (textStyle ?? DabbleText.body).on(c.ink),
      cursorColor: c.ember,
              ...
              for (var i = 0; i < widget.length; i++)
                AnimatedContainer(
                  ...
                  child: Text(
                    ...
                    style: DabbleText.title2.on(c.ink).tabular,
                  ),
                ),
            ],
          ),
