...
class TejaHeader extends StatelessWidget {
  const TejaHeader({
    super.key,
    this.title,
    this.leading,
...
/// A text action sized to its label — the safe thing to put in [TejaHeader].
class TejaHeaderAction extends StatelessWidget {
  const TejaHeaderAction(
    this.label, {
    super.key,
    this.onTap,
    this.emphasis = false,
