...
class DabbleRepository {
  DabbleRepository(this._api);
  ...
  Future<DabbleUser> profile(String username) async =>
      DabbleUser.fromJson(await _api.get<Map<String, dynamic>>('/users/$username'));
...
final dabbleRepositoryProvider = Provider<DabbleRepository>(
  (ref) => DabbleRepository(ref.watch(apiClientProvider)),
);
