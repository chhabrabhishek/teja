...
import 'package:dabble/design/components/dabble_header.dart';
    ...
    await tester.pumpWidget(
      DabbleTheme(
        ...
        child: CupertinoApp(
          home: DabbleHeader(
            title: title,
            leading: DabbleHeaderAction(leading, onTap: () {}),
            trailing: DabbleHeaderAction(trailing, onTap: () {}),
          ),
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      DabbleTheme(
        ...
        child: CupertinoApp(
          home: DabbleHeader(
            title: 'Edit profile',
            leading: DabbleHeaderAction('Cancel', onTap: () => leadingTaps++),
            trailing: DabbleHeaderAction('Save', onTap: () => trailingTaps++),
          ),
        ),
      ),
    );
